...
export function PurchaseReportView() {
  ...
  useEffect(() => {
    getDoctypeList('Contacts', ['name', 'first_name'], { customer_type: 'Purchase' }).then(
      (contacts: any[]) => {
                    ...
                    .map((row, index) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <TableCell>
                            {row.vendor_name}
                            {row.vendor_real_name ? ` - ${row.vendor_real_name}` : ''}
                          </TableCell>
                          ...
                          <TableCell sx={{ fontWeight: 700 }}>
                            ₹{row.grand_total?.toLocaleString() || 0}
                          </TableCell>
                          <TableCell
                            align="right"
                            sx={{
                          ...
                          >
                            <IconButton
                              onClick={() => handleViewPurchase(row.name)}
                              sx={{ color: 'info.main' }}
                            >
