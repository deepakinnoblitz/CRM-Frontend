    ...
    try {
      ...
      const fieldsToFetch =
        selectedFields.length > 0
          ? selectedFields
          : ['name', 'customer_name', 'estimate_date', 'total_qty', 'grand_total'];
    ...
    <DashboardContent maxWidth={false}>
      <Stack spacing={3}>
        <Stack direction="row" alignItems="center" justifyContent="space-between">
          <Typography variant="h4">Estimation Report</Typography>
                    ...
                    .map((row, index) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <TableCell>
                            {row.estimate_date
                              ? dayjs(row.estimate_date).format('DD MMM YYYY')
                              : '-'}
                          </TableCell>
                          <TableCell
                            sx={{
                          ...
                          <TableCell align="right">
                            ₹{row.tax_amount?.toLocaleString() || 0}
                          </TableCell>
                          <TableCell align="right">
                            ₹{row.sub_total?.toLocaleString() || 0}
                          </TableCell>
