...
export function LeadDetailsDialog({ open, onClose, leadId, onEdit }: Props) {
  ...
  const renderStatus = (status: string) => {
    ...
    if (status === 'Contacted' || status === 'Proposal Sent' || status === 'In Negotiation')
      color = 'warning';
        ...
        {loading ? (
          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
              ...
              <>
                ...
                <Box sx={{ margin: 2 }}>
                  ...
                  >
                    ...
                    <DetailItem
                      label="Leads Type"
                      value={lead.leads_type}
                      icon="solar:tag-horizontal-bold"
                    />
                    <DetailItem
                      label="Leads From"
                      value={lead.leads_from}
                ...
                <Box sx={{ margin: 2 }}>
                  ...
                  >
                    ...
                    <DetailItem
                      label="Owner"
                      value={lead.owner_name || lead.owner}
                      icon="solar:user-rounded-bold"
                      color="secondary.main"
                    />
                    <DetailItem
                      label="Creation"
                      value={new Date(lead.creation).toLocaleString()}
            ...
            {currentTab === 'followups' && (
              <LeadFollowupDetails title="Followup History" list={lead.followup_details || []} />
            )}
