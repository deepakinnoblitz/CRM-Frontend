              ...
              <Box>
                ...
                >
                  ...
                  <DetailItem
                    ...
                    value={renewal.vendor || '-'}
                    icon="solar:shop-bold"
                  />
                  <DetailItem
                    label="Amount"
                    value={`₹${renewal.amount?.toLocaleString() || 0}`}
              ...
              <Box sx={{ paddingTop: 3 }}>
                ...
                >
                  <DetailItem
                    label="Purchase Date"
                    value={
                      renewal.purchase_date
                        ? new Date(renewal.purchase_date).toLocaleDateString()
                        : '-'
                    }
                ...
                >
                  <Box>
                    ...
                    <Typography variant="body2">
                      {new Date(renewal.creation).toLocaleString()}
                    </Typography>
                  </Box>
                  <Box>
                    <Typography
                    ...
                    <Typography variant="body2">
                      {new Date(renewal.modified).toLocaleString()}
                    </Typography>
                  </Box>
                  <Box>
                    <Typography
