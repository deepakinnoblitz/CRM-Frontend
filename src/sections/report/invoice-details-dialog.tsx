          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 5 }}>
            ...
            <Box>
              ...
              >
                ...
                <DetailItem
                  ...
                  icon={'solar:calendar-minimalistic-bold' as any}
                  color="error.main"
                />
                <DetailItem
                  label="Billing Name"
                  value={invoice.billing_name}
                  icon={'solar:bill-list-bold' as any}
                />
                <DetailItem
                  label="Phone Number"
                ...
                <DetailItem
                  label="Grand Total"
                  value={`₹${invoice.grand_total?.toLocaleString() || 0}`}
                  icon={'solar:wad-of-money-bold' as any}
                  color="primary.main"
                />
                <DetailItem
                  label="Received Amount"
                  value={`₹${invoice.received_amount?.toLocaleString() || 0}`}
                  icon={'solar:hand-money-bold' as any}
                  color="success.main"
                />
                <DetailItem
                  label="Balance"
                  value={`₹${invoice.balance_amount?.toLocaleString() || 0}`}
                  icon={'solar:round-transfer-horizontal-bold' as any}
                  color="warning.main"
                />
              </Box>
            </Box>
                  ...
                  {invoice.table_qecz?.map((item: any, index: number) => (
                    <Box
                      ...
                      sx={{
                        ...
                        p: 1.5,
                        borderBottom: (t) =>
                          index !== invoice.table_qecz.length - 1
                    ...
                    >
                      ...
                      <Typography variant="body2" sx={{ textAlign: 'right', fontWeight: 600 }}>
                        ₹{item.sub_total?.toLocaleString() || 0}
                      </Typography>
                    </Box>
                  ))}
            ...
            <Box>
              ...
              >
                <DetailItem
                  label="Created On"
                  value={new Date(invoice.creation).toLocaleString()}
                  icon={'solar:calendar-date-bold' as any}
                />
                <DetailItem
                  label="Owner"
