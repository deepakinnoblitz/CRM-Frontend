      ...
      <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', sm: '1fr 1fr' }, gap: 3 }}>
        ...
        >
          ...
          <Stack spacing={1.5}>
            ...
            {slip.lop > 0 && <AmountRow label="LOP" amount={slip.lop} hrSettings={hrSettings} />}
