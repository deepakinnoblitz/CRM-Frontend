          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 5 }}>
            ...
            <Box>
              ...
              >
                <DetailItem
                  label="Customer"
                  value={estimation.customer_name}
                  icon="solar:user-bold"
                />
                <DetailItem label="Ref No" value={estimation.ref_no} icon="solar:tag-bold" />
                <DetailItem
                  label="Estimate Date"
                  value={estimation.estimate_date}
                  icon="solar:calendar-date-bold"
                />
                <DetailItem
                  label="Billing Name"
                  value={estimation.billing_name}
                  icon="solar:bill-list-bold"
                />
                <DetailItem
                  label="Phone Number"
                  value={estimation.phone_number}
                  icon="solar:phone-bold"
                />
                <DetailItem
                  label="Grand Total"
                  value={`₹${estimation.grand_total?.toLocaleString() || 0}`}
                  ...
                  {estimation.table_qecz?.map((item: any, index: number) => (
                    <Box
                      ...
                      sx={{
                        ...
                        p: 1.5,
                        borderBottom: (t) =>
                          index !== estimation.table_qecz.length - 1
            ...
            <Box sx={{ p: 3, bgcolor: 'background.neutral', borderRadius: 2 }}>
              ...
              >
                ...
                <DetailItem
                  label="Total Amount"
                  value={`₹${estimation.total_amount?.toLocaleString() || 0}`}
                  icon="solar:wad-of-money-bold"
                />
                <DetailItem
                  label="Grand Total"
            ...
            <Box>
              ...
              >
                <DetailItem
                  label="Created On"
                  value={new Date(estimation.creation).toLocaleString()}
                  icon="solar:calendar-date-bold"
                />
