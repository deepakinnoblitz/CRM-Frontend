      ...
      <Stack spacing={3}>
        ...
        >
          ...
          <FormControl size="small" sx={{ minWidth: 160 }}>
            <Select value={callFor} onChange={(e) => setCallFor(e.target.value)} displayEmpty>
                        ...
                        >
                          ...
                          <TableCell>
                            <Typography variant="body2">
                              {row.call_start_time
                                ? dayjs(row.call_start_time).format('DD MMM YYYY HH:mm')
                                : '-'}
                            </Typography>
                          </TableCell>
                          ...
                          >
                            <IconButton
                              onClick={() => handleViewCall(row.name)}
                              sx={{ color: 'info.main' }}
                            >
