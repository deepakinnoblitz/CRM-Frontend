          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 5 }}>
            ...
            <Box>
              ...
              >
                ...
                <DetailItem
                  label="End Time"
                  value={call.call_end_time ? new Date(call.call_end_time).toLocaleString() : '-'}
                  icon="solar:clock-circle-bold"
                />
            ...
            <Box sx={{ p: 3, bgcolor: 'background.neutral', borderRadius: 2 }}>
              ...
              >
                <DetailItem
                  label="Created On"
                  value={new Date(call.creation).toLocaleString()}
                  icon="solar:calendar-date-bold"
                />
                <DetailItem
                  label="Modified On"
                  value={new Date(call.modified).toLocaleString()}
