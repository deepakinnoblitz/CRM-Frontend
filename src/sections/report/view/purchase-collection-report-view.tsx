        ...
        >
          ...
          {summaryData.length === 0 && (
            <>
              ...
              <SummaryCard
                item={{ label: 'Paid Amount', value: 0, indicator: 'green', datatype: 'Currency' }}
              />
              <SummaryCard
                item={{ label: 'Pending Amount', value: 0, indicator: 'red', datatype: 'Currency' }}
              />
            </>
          )}
        </Box>
                    ...
                    .map((row, index) => (
                      ...
                      >
                        ...
                        <TableCell sx={{ color: 'success.main', fontWeight: 600 }}>
                          {fCurrency(row.amount_paid)}
                        </TableCell>
                        <TableCell sx={{ color: 'error.main', fontWeight: 600 }}>
                          {fCurrency(row.amount_pending)}
                        </TableCell>
                        <TableCell>
