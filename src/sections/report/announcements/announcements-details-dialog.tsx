              ...
              <Box sx={{ flexGrow: 1 }}>
                ...
                <Typography variant="body2" sx={{ color: 'text.secondary', fontWeight: 600 }}>
                  ...
                  {announcement.creation
                    ? new Date(announcement.creation).toLocaleDateString()
                    : '-'}
                </Typography>
              </Box>
              <Box
            ...
            <Box sx={{ p: 3, bgcolor: 'background.neutral', borderRadius: 2 }}>
              ...
              >
                ...
                <DetailItem
                  label="Created On"
                  value={
                    announcement.creation ? new Date(announcement.creation).toLocaleString() : '-'
                  }
                ...
                <DetailItem
                  label="Last Modified"
                  value={
                    announcement.modified ? new Date(announcement.modified).toLocaleString() : '-'
                  }
                  icon="solar:calendar-bold"
                />
              </Box>
