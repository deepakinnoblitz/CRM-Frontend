        ...
        <Stack spacing={3} sx={{ p: 3 }}>
          <Stack spacing={1.5}>
            ...
            <Autocomplete
              ...
              value={
                users.find((u) => u.email === filters.user) ||
                (filters.user ? { email: filters.user, name: filters.user } : null)
              }
          ...
          <Stack spacing={1.5}>
            ...
            <Autocomplete
              ...
              value={
                docTypes.find((dt) => dt.name === filters.allow) ||
                (filters.allow ? { name: filters.allow } : null)
              }
          ...
          <Stack spacing={1.5}>
            ...
            <Autocomplete
              ...
              value={
                forValueOptions.find((opt) => opt.name === filters.for_value) ||
                (filters.for_value ? { name: filters.for_value } : null)
              }
              isOptionEqualToValue={(option, value) => option.name === value?.name}
              ...
              renderInput={(params) => (
                <TextField
                  {...params}
                  placeholder={
                    filters.allow ? `Search ${filters.allow} value...` : 'Search value...'
                  }
                  size="small"
                  sx={{
                    '& .MuiOutlinedInput-root': {
