        ...
        <Stack spacing={3} sx={{ pt: 2 }}>
          {!hideUserField && (
            <Autocomplete
              ...
              renderInput={(params) => (
                <TextField {...params} label="User" required placeholder="Select user" />
              )}
              loading={loading}
            />
          )}
          ...
          <Autocomplete
            ...
            renderInput={(params) => (
              <TextField {...params} label="Allow" required placeholder="Select doctype" />
            )}
            loading={loading}
          />
          ...
          <Autocomplete
            ...
            onChange={(e, newValue) =>
              setFormData({ ...formData, for_value: newValue?.name || '' })
            }
            renderInput={(params) => (
              <TextField
                {...params}
