...
const PurchaseCollectionNewEditForm = forwardRef(
  ({ currentPurchaseCollection, onLoadingChange }: Props, ref) => {
    ...
    useEffect(() => {
      getDoctypeList('Purchase', ['name', 'vendor_name', 'grand_total', 'balance_amount']).then(
        (data) => {
