...
export default function ChatInfo({
  ...
  const fetchMembers = useCallback(async () => {
    try {
      ...
      const chatMembers =
        (Array.isArray(results) && results[0]?.chat_members) || data?.chat_members || [];
          ...
          {tab === 0 && (
            ...
            >
              ...
              {sharedContent.images.length === 0 && (
                <Typography
                  variant="body2"
                  sx={{ color: 'text.disabled', textAlign: 'center', width: 1, mt: 4 }}
                >
                  No shared media
                </Typography>
              )}
          ...
          <Box sx={{ position: 'relative' }}>
            <Avatar
              ...
              sx={{
                ...
                color:
                  channel.avatar_url || channel.channel_info?.avatar
                    ? 'text.secondary'
                      ...
                      <Avatar
                        ...
                        sx={{
                          ...
                          color: (t) =>
                            member.profile_image
                              ? 'text.secondary'
                              : stringToDarkColor(member.name || ''),
                          width: 44,
                          height: 44,
                          border: (t) =>
                            member.profile_image ? `solid 1px ${t.palette.divider}` : 'none',
                          '& img': {
                            objectFit: 'contain',
                            padding: 0.5,
                          },
