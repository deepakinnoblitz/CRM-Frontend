...
if (typeof document !== 'undefined') {
  const styleEl =
    document.getElementById('lk-custom-styles') ||
    (() => {
          ...
          {!lkConnected && (
            ...
            >
              ...
              >
                ...
                >
                  <Iconify
                    icon={'solar:videocamera-record-bold' as any}
                    width={28}
                    sx={{ color: 'white' }}
                  />
                </Box>
          ...
          >
            <GroupCallLayout
              onParticipantsChange={(n) => {
                participantsCountRef.current = n;
              }}
          ...
          {!isMinimized && (
            <IconButton
              ...
              sx={{
                ...
                color: 'white',
                '&:hover': {
                  bgcolor: isAudioMuted ? 'error.dark' : alpha(theme.palette.common.white, 0.3),
                },
              }}
            >
              <Iconify
                icon={
                  (isAudioMuted ? 'solar:microphone-slash-bold' : 'solar:microphone-bold') as any
                }
              />
            </IconButton>
          )}
          ...
          {callType === 'video' && !isMinimized && (
            <IconButton
              ...
              sx={{
                ...
                color: 'white',
                '&:hover': {
                  bgcolor: isVideoDisabled ? 'error.dark' : alpha(theme.palette.common.white, 0.3),
                },
              }}
            >
              <Iconify
                icon={
                  (isVideoDisabled
                    ...
                    : 'solar:videocamera-record-bold-duotone') as any
                }
              />
            </IconButton>
          )}
          ...
          <Iconify
            icon={
              (isFullScreen
                ...
                : 'solar:maximize-square-3-bold') as any
            }
          />
        </IconButton>
      )}
  ...
  return (
    <LayoutContextProvider>
      ...
      >
        ...
        {/* Video and Chat row */}
        <Box
          sx={{ flex: 1, display: 'flex', minHeight: 0, overflow: 'hidden', position: 'relative' }}
        >
...
function GroupCallControlBar({
  ...
  const renderDeviceList = (
    ...
    <Box
      className="custom-device-dropdown"
      sx={{ p: '10px !important', minWidth: '440px !important' }}
    >
      {devices.map((device) => {
      ...
      {devices.length === 0 && (
        <Typography
          sx={{ color: 'rgba(255,255,255,0.4)', fontSize: '12px', textAlign: 'center', py: 1 }}
        >
          No devices found
        </Typography>
      )}
    ...
    <Stack direction="row" spacing={1} alignItems="center" className="custom-control-bar">
      ...
      <Box sx={{ display: 'flex', alignItems: 'center', gap: '4px', position: 'relative' }}>
        ...
        {audioOpen && (
          ...
          >
            {renderDeviceList(audioDevices, activeAudioId, setAudioDevice, () =>
              setAudioOpen(false)
            )}
          </Box>
        )}
      ...
      <Box sx={{ display: 'flex', alignItems: 'center', gap: '4px', position: 'relative' }}>
        ...
        {videoOpen && (
          ...
          >
            {renderDeviceList(videoDevices, activeVideoId, setVideoDevice, () =>
              setVideoOpen(false)
            )}
          </Box>
        )}
      ...
      <Box sx={{ display: 'flex', alignItems: 'center' }}>
        ...
        <Box onClickCapture={() => setIsExplicitDisconnect(true)}>
          <DisconnectButton>
            <Iconify
              icon={'solar:phone-bold' as any}
              sx={{ color: 'white', transform: 'rotate(135deg)', display: 'block' }}
            />
          </DisconnectButton>
        </Box>
      </Box>
