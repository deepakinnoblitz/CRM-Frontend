        ...
        <Stack spacing={1.5}>
            ...
            <Autocomplete
                ...
                value={
                    value === 'all' || value === ''
                        ? null
                        : optList.find((opt) => (typeof opt === 'string' ? opt === value : opt.name === value)) || null
                }
                onChange={(event, newValue) => {
                    handleFilterChange(field, newValue ? (typeof newValue === 'string' ? newValue : newValue.name) : 'all');
                }}
                options={optList}
            ...
            <LocalizationProvider dateAdapter={AdapterDayjs}>
                ...
                <Scrollbar>
                    <Stack spacing={3} sx={{ p: 3 }}>
                        {renderAutocomplete('Status', 'status', filters.status, options.statuses, (opt) => opt, 'Select status')}
                        {renderAutocomplete('Project', 'project', filters.project, options.projects, (opt) => opt.project, 'Search projects')}
                        {renderAutocomplete('Priority', 'priority', filters.priority, options.priorities, (opt) => opt, 'Select priority')}
                        {renderAutocomplete(
                            'Assignee',
                            'assignee',
                            filters.assignee,
                        ...
                        {renderAutocomplete('Department', 'department', filters.department, options.departments, (opt) => opt.department_name, 'Search departments')}
                        {renderDate}
                    </Stack>
                </Scrollbar>
