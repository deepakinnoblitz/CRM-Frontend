...
const TABS = [
  {
    value: 'purchases',
    label: 'Purchases',
    icon: <Iconify icon={'solar:cart-large-bold-duotone' as any} width={24} />,
  },
  {
    value: 'collections',
    label: 'Settlements',
    icon: <Iconify icon={'solar:wad-of-money-bold-duotone' as any} width={24} />,
  },
];
...
export function PurchaseManagementView() {
  ...
  const [currentTab, setCurrentTab] = useState(
    tabParam === 'collections' ? 'collections' : 'purchases'
  );
