...
import {
  useEmployeeEvaluationPoints,
  useEmployeeEvaluationTraitCategories,
} from 'src/hooks/useEmployeeEvaluation';

import {
  createEmployeeEvaluationTrait,
  updateEmployeeEvaluationTrait,
...
export function EmployeeEvaluationTraitFormDialog({
  open,
  onClose,
  onSuccess,
  selectedTrait,
  ...
  const { data: traitCategories, refetch: refetchCategories } =
    useEmployeeEvaluationTraitCategories();
        ...
        <DialogContent dividers>
          <Stack spacing={3} sx={{ pt: 1 }}>
            ...
            <Autocomplete
              ...
              value={
                traitCategories.find((c: any) => c.category_name === formData.category) || null
              }
            ...
            {evaluationPoints.map((point) => {
              const scoreRow = formData.evaluation_scores.find(
                (s) => s.evaluation_point === point.name
              );
              return (
