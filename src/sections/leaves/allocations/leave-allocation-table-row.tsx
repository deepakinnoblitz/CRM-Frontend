    ...
    >
      ...
      <TableCell align="right" sx={{ px: 1 }}>
        <Stack direction="row" spacing={1} justifyContent="flex-end">
          <IconButton size="small" onClick={(e) => handleClick(e, onView)} color="info">
            <Iconify icon="solar:eye-bold" width={22} />
          </IconButton>

          {canEdit && (
            <IconButton size="small" onClick={(e) => handleClick(e, onEdit)} color="primary">
              <Iconify icon={'solar:pen-bold' as any} width={22} />
            </IconButton>
          )}

          {canDelete && (
            <IconButton size="small" onClick={(e) => handleClick(e, onDelete)} color="error">
