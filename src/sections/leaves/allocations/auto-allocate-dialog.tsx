...
import {
  getLeaveAllocationPreview,
  autoAllocateMonthlyLeaves,
  type EmployeeAllocationPreview,
    ...
    >
        ...
        {step === 'input' ? (
          <Box sx={{ mt: 2 }}>
            <Stack direction="row" spacing={2}>
              <LocalizationProvider dateAdapter={AdapterDayjs}>
                <DatePicker
                  ...
                  onChange={(newValue) =>
                    setYear(newValue ? newValue.year() : new Date().getFullYear())
                  }
            ...
            <Typography variant="body2" sx={{ mt: 2, color: 'text.secondary' }}>
              This will allocate Paid Leave (1 day), Unpaid Leave (30 days), and Permission (120
              minutes) to all active employees for {monthNames[month - 1]} {year}.
            </Typography>
          </Box>
        ) : (
          <Box>
            ...
            <TableContainer sx={{ border: 1, borderColor: 'divider', borderRadius: 2 }}>
              <Table stickyHeader>
                <TableHead>
                  <TableRow>
                    <TableCell sx={{ bgcolor: 'background.neutral', fontWeight: 700, width: 60 }}>
                      S.No
                    </TableCell>
                    <TableCell sx={{ bgcolor: 'background.neutral', fontWeight: 700, width: 200 }}>
                      Employee
                    </TableCell>
                    <TableCell
                      sx={{
                    ...
                    <TableCell sx={{ bgcolor: 'background.neutral', fontWeight: 700 }}>
      ...
      <DialogActions sx={{ p: 2.5, pt: 2 }}>
        ...
        {step === 'input' ? (
          ...
          <LoadingButton variant="contained" loading={allocating} onClick={handleAllocate}>
            Allocate
          </LoadingButton>
        )}
      </DialogActions>
