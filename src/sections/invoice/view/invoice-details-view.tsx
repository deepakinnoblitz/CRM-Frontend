...
export function InvoiceDetailsView() {
  ...
  if (attachments) {
    try {
      ...
      if (Array.isArray(parsed)) {
        ...
        parsedAttachments = [
          { name: attachments.split('/').pop() || 'Attachment', url: attachments },
        ];
      }
    } catch {
      parsedAttachments = [
  ...
  const discountAmount =
    overall_discount_type === 'Flat' ? overall_discount : (subTotal * overall_discount) / 100;
  ...
  return (
    <DashboardContent maxWidth={false}>
            ...
            <Stack spacing={1.5}>
              ...
              <Stack
                ...
                sx={{
                  ...
                  border: (theme) =>
                    `1px solid ${alpha((balance_amount || 0) > 0 ? theme.palette.error.main : theme.palette.success.main, 0.12)}`,
                }}
              >
                <Stack direction="row" justifyContent="space-between" alignItems="center">
                ...
                <Stack direction="row" justifyContent="space-between" alignItems="center">
                  ...
                  <Typography
                    variant="h6"
                    color={(balance_amount || 0) > 0 ? 'error.main' : 'success.main'}
                  >
                    {fCurrency(balance_amount)}
                  </Typography>
                </Stack>
              </Stack>
            </Stack>
                ...
                <TableHead>
                  <TableRow sx={{ bgcolor: (theme) => alpha(theme.palette.grey[500], 0.04) }}>
                    ...
                    <TableCell
                      width={60}
                      align="center"
                      sx={{ fontWeight: 'fontWeightBold', py: 2 }}
                    >
                      Qty
                    </TableCell>
                    <TableCell
                  ...
                  <Stack spacing={1}>
                    {parsedAttachments.map((file, index) => (
                      ...
                      >
                        ...
                        <Iconify
                          icon={'solar:download-bold' as any}
                          width={16}
            ...
            >
              <Stack direction="row" justifyContent="space-between" alignItems="center">
                ...
                <Typography variant="subtitle2">
                  {fCurrency(
                    table_qecz.reduce(
                      (sum: number, row: any) => sum + (row.sub_total - row.tax_amount),
                      0
                    )
                  )}
                </Typography>
              ...
              <Stack direction="row" justifyContent="space-between" alignItems="center">
                <Typography variant="body2" color="text.secondary">
                  Discount ({overall_discount_type === 'Flat' ? 'Flat' : `${overall_discount}%`})
                </Typography>
              ...
              <Stack direction="row" justifyContent="space-between" alignItems="center">
                <Stack direction="row" spacing={1} alignItems="center">
                  <Iconify
                    icon={'solar:hand-money-bold-duotone' as any}
                    width={16}
              ...
              <Stack direction="row" justifyContent="space-between" alignItems="center">
                <Stack direction="row" spacing={1} alignItems="center">
                  <Iconify
                    icon={'solar:wallet-2-bold-duotone' as any}
                    width={20}
                    sx={{ color: (balance_amount || 0) > 0 ? 'error.main' : 'success.main' }}
                  />
                  <Typography
                    variant="subtitle1"
                    sx={{ color: (balance_amount || 0) > 0 ? 'error.main' : 'success.main' }}
      ...
      <Backdrop sx={{ color: '#fff', zIndex: (theme) => theme.zIndex.drawer + 1 }} open={printing}>
