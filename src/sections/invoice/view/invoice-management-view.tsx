...
const TABS = [
  {
    value: 'invoices',
    label: 'Invoices',
    icon: <Iconify icon={'solar:bill-list-bold-duotone' as any} width={20} />,
  },
  {
    value: 'collections',
    label: 'Invoice Collection',
    icon: <Iconify icon={'solar:bill-check-bold-duotone' as any} width={20} />,
  },
];
...
export function InvoiceManagementView({ hideHeader = false }: { hideHeader?: boolean }) {
  ...
  const [currentTab, setCurrentTab] = useState(
    subTabParam === 'collections' ? 'collections' : 'invoices'
  );
