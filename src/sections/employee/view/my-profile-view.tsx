          ...
          {loading ? (
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 5 }}>
              ...
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 3 }}>
                ...
                >
                  <Box
                    sx={{
                      ...
                      boxShadow: (theme) =>
                        `0 8px 32px ${theme.palette.mode === 'light' ? 'rgba(0,0,0,0.12)' : 'rgba(0,0,0,0.4)'}`,
                      flexShrink: 0,
                    }}
                  >
                    {employee.profile_picture ? (
                ...
                <Box sx={{ flexGrow: 1, minWidth: 0 }}>
                  ...
                  <Typography variant="body2" sx={{ color: 'text.secondary', fontWeight: 600 }}>
                    {employee.designation} at {employee.department}
                  </Typography>
                </Box>
              ...
              <Box>
                ...
                >
                  ...
                  <DetailItem
                    label="Office Phone"
                    value={employee.office_phone_number}
                    icon="solar:phone-bold"
                  />
              ...
              <Box>
                ...
                >
                  ...
                  <DetailItem
                    label="Joining Date"
                    value={fDate(employee.date_of_joining, 'DD-MM-YYYY')}
                  ...
                  <DetailItem
                    label="Date of Birth"
                    value={fDate(employee.dob, 'DD-MM-YYYY')}
                    icon="solar:calendar-bold"
                  />
                </Box>
              </Box>
              ...
              <Box>
                ...
                >
                  ...
                  >
                    ...
                    {employee.ctc
                      ? fNumber(parseFloat(employee.ctc), { locale: hrSettings.default_locale })
                      : '-'}
                  </Typography>
                </Box>
                ...
                >
                  ...
                  <Box
                    sx={{
                      ...
                      borderRadius: 2,
                      bgcolor: (theme) =>
                        theme.palette.mode === 'light' ? 'success.lighter' : 'grey.900',
                  ...
                  <Box
                    sx={{
                      ...
                      borderRadius: 2,
                      bgcolor: (theme) =>
                        theme.palette.mode === 'light' ? 'warning.lighter' : 'grey.900',
                  ...
                  >
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 2.5 }}>
                      ...
                      <Typography
                        variant="subtitle1"
                        sx={{ fontWeight: 700, color: 'warning.darker' }}
                      >
                        Deductions
                      </Typography>
                    </Box>
                    ...
                    <Stack direction="row" spacing={4}>
                      <Box sx={{ textAlign: 'right' }}>
                        ...
                        >
                          ...
                          {fNumber(employee.total_earnings || 0, {
                      ...
                      <Box sx={{ textAlign: 'right' }}>
                        ...
                        >
                          ...
                          <Box
                            component="span"
                            sx={{ fontFamily: "Arial, 'sans-serif'", mx: 0.5, color: 'error.main' }}
                          >
                            {hrSettings.currency_symbol}
                          </Box>
                          {fNumber(employee.total_deductions || 0, {
                            locale: hrSettings.default_locale,
                          })}
                        </Typography>
                      </Box>
            ...
            <Box sx={{ py: 10, textAlign: 'center' }}>
              ...
              <Typography variant="body2" sx={{ color: 'text.disabled' }}>
                Please ensure your account is linked to an Employee record.
              </Typography>
            </Box>
          )}
        </Card>
