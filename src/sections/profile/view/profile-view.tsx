...
export function ProfileView() {
  ...
  const handleChangePassword = async () => {
    ...
    try {
      const response = await frappeRequest(
        '/api/method/company.company.frontend_api.update_my_password',
        {
          method: 'POST',
          body: JSON.stringify({
  ...
  const handleSaveProfile = async () => {
    try {
      const response = await frappeRequest(
        '/api/method/company.company.frontend_api.update_profile_info',
        {
          method: 'POST',
          body: JSON.stringify({
      ...
      if (data.message && data.message.status === 'success') {
        ...
        setSnackbar({
          open: true,
          message: data.message?.message || 'Failed to update profile',
          severity: 'error',
        });
      }
    } catch (error) {
