...
export function ProposalTableFiltersDrawer({
    open,
    onOpen,
    onClose,
    filters,
    ...
    const renderDate = (
        <Stack spacing={1.5}>
            ...
            <LocalizationProvider dateAdapter={AdapterDayjs}>
                <DatePicker
                    value={filters.proposal_date ? dayjs(filters.proposal_date) : null}
                    onChange={(newValue: Dayjs | null) => {
                        handleFilterChange('proposal_date', newValue ? newValue.format('YYYY-MM-DD') : '');
                    }}
                    slotProps={{
                        textField: {
                            fullWidth: true,
