    ...
    try {
      const payload = {
        ...
        scheduled_on: formData.scheduled_on
          ? dayjs(formData.scheduled_on).format('YYYY-MM-DD')
          : null,
      };
              ...
              >
                <Autocomplete
                  ...
                  getOptionLabel={(option) =>
                    typeof option === 'string' ? option : option.applicant_name || option.name
                  }
                  isOptionEqualToValue={(option, value) =>
                    option.name === (typeof value === 'string' ? value : value?.name)
                  }
                  value={applicants.find((a) => a.name === formData.job_applicant) || null}
                  onChange={(_, newValue) => {
                ...
                <Box sx={{ position: 'relative' }}>
                  ...
                  >
                    {formData.resume_attachment ? (
                      ...
                      <>
                        <Iconify
                          icon={'solar:file-text-linear' as any}
                          width={18}
                      ...
                      <input
                        ...
                        onChange={async (e) => {
                          ...
                          try {
                            ...
                            setFormData((prev: any) => ({
                              ...prev,
                              resume_attachment: result.file_url,
                            }));
                          } catch (err: any) {
                            setSnackbar({
                              open: true,
                ...
                >
                  <DatePicker
                    ...
                    onChange={(newValue) => {
                      setFormData({
                        ...formData,
                        scheduled_on: newValue?.isValid() ? newValue.format('YYYY-MM-DD') : '',
                      });
                    }}
                    slotProps={{
                      textField: {
                  ...
                  <TimePicker
                    ...
                    onChange={(newValue) => {
                      setFormData({
                        ...formData,
                        from_time: newValue?.isValid() ? newValue.format('HH:mm:ss') : '',
                      });
                    }}
                    slotProps={{
                      textField: {
                  ...
                  <TimePicker
                    ...
                    onChange={(newValue) => {
                      setFormData({
                        ...formData,
                        to_time: newValue?.isValid() ? newValue.format('HH:mm:ss') : '',
                      });
                    }}
                    slotProps={{
                      textField: {
                ...
                >
                  ...
                  >
                    <Autocomplete
                      ...
                      onChange={(_, val) =>
                        handleFeedbackChange(index, 'interview_type', val || '')
                      }
                      renderInput={(params) => (
                        <TextField
                          {...params}
                    ...
                    <Autocomplete
                      ...
                      options={users}
                      getOptionLabel={(option) =>
                        typeof option === 'string' ? option : option.full_name || option.name
                      }
                      isOptionEqualToValue={(option, value) =>
                        option.name === (typeof value === 'string' ? value : value?.name)
                      }
                      ...
                      onChange={(_, val) =>
                        handleFeedbackChange(index, 'interviewer', val?.name || '')
                      }
                      renderOption={(props, option) => (
                        <Box component="li" {...props} key={option.name}>
                          <Box>
                    ...
                    <Box sx={{ gridColumn: 'span 2' }}>
                      ...
                      <Rating
                        ...
                        onChange={(event, newValue) =>
                          handleFeedbackChange(index, 'rating', newValue)
                        }
                      />
                    </Box>
