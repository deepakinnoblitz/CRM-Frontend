        ...
        <DashboardContent maxWidth={false}>
            ...
            <Stack spacing={3}>
                ...
                <Card sx={{ p: 3 }}>
                    ...
                    <Stack spacing={3}>
                        <Box sx={{ p: 2, borderRadius: 1.5, bgcolor: (t) => alpha(t.palette.grey[500], 0.04), border: (t) => `1px solid ${alpha(t.palette.grey[500], 0.12)}` }}>
                            ...
                            <Typography variant="body2" sx={{ fontSize: 14, wordBreak: 'break-all', fontFamily: 'monospace' }}>
                                {page.page_access_token ? `${page.page_access_token.substring(0, 15)}••••••••` : '—'}
                            </Typography>
                        </Box>
                        ...
                        {page.long_lived_token && (
                            <Box sx={{ p: 2, borderRadius: 1.5, bgcolor: (t) => alpha(t.palette.grey[500], 0.04), border: (t) => `1px solid ${alpha(t.palette.grey[500], 0.12)}` }}>
                                ...
                                <Typography variant="body2" sx={{ fontSize: 14, wordBreak: 'break-all', fontFamily: 'monospace' }}>
                                    {page.long_lived_token ? `${page.long_lived_token.substring(0, 15)}••••••••` : '—'}
                                </Typography>
                            </Box>
                        )}
                    </Stack>
