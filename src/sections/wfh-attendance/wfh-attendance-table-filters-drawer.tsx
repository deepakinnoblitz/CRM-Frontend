  ...
  const renderEmployee = (
    <Stack spacing={1.5}>
      ...
      <Autocomplete
        ...
        value={
          options.employees.find((emp: any) => emp.name === filters.employee) ||
          (filters.employee === 'all' ? { name: 'all', employee_name: 'All Employees' } : null)
        }
      ...
      <LocalizationProvider dateAdapter={AdapterDayjs}>
        <Stack spacing={2}>
          <DatePicker
            ...
            onChange={(newValue) =>
              handleFilterChange('startDate', newValue?.format('YYYY-MM-DD') || null)
            }
            slotProps={{
              textField: {
                fullWidth: true,
          ...
          <DatePicker
            ...
            onChange={(newValue) =>
              handleFilterChange('endDate', newValue?.format('YYYY-MM-DD') || null)
            }
            slotProps={{
              textField: {
                fullWidth: true,
