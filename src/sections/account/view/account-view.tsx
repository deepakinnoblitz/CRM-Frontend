...
export function AccountView() {
  ...
  const canReset = filters.country !== 'all' || filters.state !== 'all' || filters.city !== 'all';
  ...
  const handleBulkDelete = async () => {
    try {
      ...
      setSnackbar({
        open: true,
        message: `${selected.length} accounts deleted successfully`,
        severity: 'success',
      });
      setSelected([]);
      loadAccounts();
  ...
  return (
    <DashboardContent maxWidth={false}>
          ...
          >
            <TextField
              ...
              onChange={(e) => {
                ...
                if (e.target.value)
                  setValidationErrors((prev) => ({ ...prev, accountName: false }));
              }}
              required
      ...
      <AccountImportDialog open={openImport} onClose={handleCloseImport} onRefresh={loadAccounts} />
