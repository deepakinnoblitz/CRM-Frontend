...
export function EventsView() {
  ...
  const handleEventClick = async (info: any) => {
    ...
    if (event) {
      ...
      setEventData({
        ...
        event_category:
          event.event_category && event.event_category.trim() !== ''
  ...
  const handleEventDrop = async (info: any) => {
    ...
    try {
      ...
      setSnackbar({
        open: true,
        message: error.message || 'Failed to update event position',
        severity: 'error',
      });
      info.revert();
    }
  ...
  const handleEventResize = async (info: any) => {
    ...
    try {
      ...
      setSnackbar({
        open: true,
        message: error.message || 'Failed to update event duration',
        severity: 'error',
      });
      info.revert();
    }
                    ...
                    <Grid size={{ xs: 12, md: 6 }}>
                      <FormControl fullWidth>
                        ...
                        <Select
                          ...
                          onChange={(e) =>
                            setEventData({ ...eventData, event_category: e.target.value as string })
                          }
                        >
                  ...
                  <Grid size={{ xs: 12, md: 6 }}>
                    <DateTimePicker
                      ...
                      onChange={(newValue) =>
                        setEventData({
                          ...eventData,
                          starts_on: newValue ? newValue.format('YYYY-MM-DD HH:mm:ss') : '',
                        })
                      }
                  ...
                  <Grid size={{ xs: 12, md: 6 }}>
                    <DateTimePicker
                      ...
                      onChange={(newValue) =>
                        setEventData({
                          ...eventData,
                          ends_on: newValue ? newValue.format('YYYY-MM-DD HH:mm:ss') : '',
                        })
                      }
                      slotProps={{ textField: { fullWidth: true } }}
                    />
        ...
        <DialogActions sx={{ p: 3, pt: 2, gap: 1.5 }}>
          {selectedEvent && (
            <Button
              color="error"
              variant="outlined"
              onClick={() => setConfirmDelete({ open: true, id: selectedEvent.name })}
              ...
              <Grid key={item.label} size={{ xs: 12, md: 4 }}>
                <Box
                  ...
                  sx={{
                    ...
                    textAlign: 'center',
                    bgcolor: alpha(
                      theme.palette[item.color as 'primary' | 'success' | 'warning'].main,
                      0.04
                    ),
