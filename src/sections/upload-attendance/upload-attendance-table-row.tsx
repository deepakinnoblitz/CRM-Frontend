...
export function UploadAttendanceTableRow({
  ...
  return (
    ...
    >
      ...
      <TableCell>
        <Typography variant="body2">{row.upload_date ? fDate(row.upload_date) : '-'}</Typography>
      </TableCell>

      <TableCell>
        <Typography variant="body2">{row.att_fr_date ? fDate(row.att_fr_date) : '-'}</Typography>
      </TableCell>

      <TableCell>
        <Typography variant="body2">{row.att_to_date ? fDate(row.att_to_date) : '-'}</Typography>
      </TableCell>
