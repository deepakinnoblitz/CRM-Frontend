...
export default function MeetingDialog({
  ...
  useEffect(() => {
    if (open) {
      getDoctypeList('Lead', ['name', 'lead_name', 'converted_contact', 'converted_account']).then(
        setLeadOptions
      );
  ...
  const handleSaveMeeting = async () => {
    ...
    if (meetingData.meet_for === 'Accounts' && !meetingData.accounts_name)
      errors.accounts_name = true;
            ...
            <Box sx={{ py: 2, display: 'flex', flexDirection: 'column', gap: 4 }}>
                    ...
                    {meetingData.meet_for === 'Others' && (
                      <Grid size={{ xs: 12, md: 6 }}>
                        <TextField
                          ...
                          onChange={(e) =>
                            setMeetingData({ ...meetingData, enter_id: e.target.value })
                          }
                        />
                      </Grid>
                    )}
                    ...
                    {meetingData.meet_for === 'Lead' && (
                      <Grid size={{ xs: 12, md: 6 }}>
                        <Autocomplete
                          ...
                          value={
                            leadOptions.find((opt) => opt.name === meetingData.lead_name) || null
                          }
                          onChange={(_, newValue) => {
                            setMeetingData({
                              ...meetingData,
                      ...
                      <Grid size={{ xs: 12, md: 6 }}>
                        <Autocomplete
                          ...
                          getOptionLabel={(option) =>
                            typeof option === 'string'
                              ? option
                              : `${option.first_name || ''} ${option.last_name || ''} (${option.name})`.trim()
                          }
                          value={
                            contactOptions.find((opt) => opt.name === meetingData.contact_name) ||
                            null
                          }
                          onChange={(_, newValue) =>
                            setMeetingData({ ...meetingData, contact_name: newValue?.name || '' })
                          }
                          renderInput={(params) => (
                            <TextField
                              {...params}
                    ...
                    {meetingData.meet_for === 'Accounts' && (
                      <Grid size={{ xs: 12, md: 6 }}>
                        <Autocomplete
                          ...
                          value={
                            accountOptions.find((opt) => opt.name === meetingData.accounts_name) ||
                            null
                          }
                          onChange={(_, newValue) =>
                            setMeetingData({ ...meetingData, accounts_name: newValue?.name || '' })
                          }
                          renderInput={(params) => (
                            <TextField
                              {...params}
                      ...
                      <FormControl fullWidth>
                        ...
                        <Select
                          ...
                          onChange={(e) =>
                            setMeetingData({
                              ...meetingData,
                              outgoing_call_status: e.target.value as string,
                            })
                          }
                        >
                        ...
                        <FormControl fullWidth>
                          ...
                          <Select
                            ...
                            onChange={(e) =>
                              setMeetingData({
                                ...meetingData,
                                completed_meet_status: e.target.value as string,
                              })
                            }
                          >
                            {[
                  ...
                  <Grid size={{ xs: 12, md: 6 }}>
                    <DateTimePicker
                      ...
                      onChange={(newValue) =>
                        setMeetingData({
                          ...meetingData,
                          from: newValue ? newValue.format('YYYY-MM-DD HH:mm:ss') : '',
                        })
                      }
                    />
                  </Grid>
                  <Grid size={{ xs: 12, md: 6 }}>
                    <DateTimePicker
                      ...
                      onChange={(newValue) =>
                        setMeetingData({
                          ...meetingData,
                          to: newValue ? newValue.format('YYYY-MM-DD HH:mm:ss') : '',
                        })
                      }
                    />
                  </Grid>
                    ...
                    <FormControl fullWidth>
                      ...
                      <Select
                        ...
                        onChange={(e) =>
                          setMeetingData({
                            ...meetingData,
                            meeting_venue: e.target.value as string,
                          })
                        }
                      >
                    ...
                    control={
                      <Android12Switch
                        ...
                        onChange={(e) =>
                          setMeetingData({
                            ...meetingData,
                            enable_reminder: e.target.checked ? 1 : 0,
                          })
                        }
                      />
                    }
                  ...
                  {meetingData.enable_reminder === 1 && (
                    <Box>
                      <TimePicker
                        ...
                        value={dayjs()
                          .startOf('day')
                          .add(meetingData.remind_before_minutes || 60, 'minutes')}
              ...
              <Box>
                ...
                <TextField
                  ...
                  onChange={(e) =>
                    setMeetingData({ ...meetingData, completed_meet_notes: e.target.value })
                  }
                />
              </Box>
            </Box>
