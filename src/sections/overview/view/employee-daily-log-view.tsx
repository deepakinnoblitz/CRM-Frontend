...
export function EmployeeDailyLogView() {
  ...
  const emptyRows =
    !loading && sessions.length > 0 ? (sessions.length < 5 ? 5 - sessions.length : 0) : 0;
  ...
  return (
    <DashboardContent maxWidth={false}>
      ...
      <EmployeePresenceSettingsDialog open={openSettings} onClose={() => setOpenSettings(false)} />
