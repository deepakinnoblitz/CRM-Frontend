  ...
  const handleStatusClick = async (newStatus: string) => {
    if (newStatus === 'Available' && isAutoStatusEnabled) {
      if (!('IdleDetector' in window)) {
        setIdleSupportError(
          'Your browser does not support automatic idle detection. Please use a modern browser like Chrome or Edge to enable the "Available" status.'
        );
      ...
      try {
        ...
        if (permission !== 'granted') {
          ...
          setIdleSupportError(
            'Permission for idle detection was denied or is restricted by your browser (e.g. Incognito mode). This is required for the "Available" status.'
          );
          setIdlePermissionDialogOpen(true);
          handleClose();
          return;
  ...
  const statusOptions = [
    {
      ...
      buttonIcon: 'ph:check-circle-fill',
    },
    {
      ...
      buttonIcon: 'ph:minus-circle-fill',
    },
    {
  ...
  return (
    <>
      ...
      >
        {statusName === 'Break' ? (
          ...
          <>
            <Typography
              variant="body2"
              sx={{ color: 'text.secondary', fontWeight: 500, fontSize: '14px' }}
            >
              Today Active Time:
            </Typography>
      ...
      >
        ...
        <DialogContent
          sx={{ px: 4, pt: 6, pb: 4, textAlign: 'center', position: 'relative', zIndex: 1 }}
        >
          ...
          <Typography
            variant="h5"
            sx={{ fontWeight: 800, color: 'text.primary', mb: 1, letterSpacing: -0.5 }}
          >
            Good{' '}
          ...
          <Button
            ...
            onClick={async () => {
              if (isAutoStatusEnabled) {
                if (!('IdleDetector' in window)) {
                  setIdleSupportError(
                    'Your browser does not support automatic idle detection. Please use a modern browser like Chrome or Edge.'
                  );
                  setIdlePermissionDialogOpen(true);
                  return;
                }
                ...
                if (permission !== 'granted') {
                  setIdleSupportError(
                    'Permission for idle detection was denied or is restricted by your browser.'
                  );
                  setIdlePermissionDialogOpen(true);
                  return;
                }
      ...
      >
        <DialogTitle
          sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', pt: 5, pb: 1 }}
        >
          <Box
            sx={{
              width: 64,
          ...
          >
            <Iconify
              icon={'ph:warning-circle-fill' as any}
        ...
        <DialogContent sx={{ py: 1.5, textAlign: 'center' }}>
          <Typography variant="body2" sx={{ color: 'text.secondary', px: 3 }}>
            You haven&apos;t filed a timesheet for today. Please complete it before going offline to
      ...
      <Dialog open={infoDialogOpen} onClose={handleInfoDialogClose} maxWidth="sm" fullWidth>
        ...
        <DialogActions sx={{ justifyContent: 'center', pb: 2 }}>
          {isLogoutDialog ? (
            <>
              <Button onClick={handleInfoDialogClose} sx={{ minWidth: 100, mr: 1 }}>
                Cancel
              </Button>
              <Button
            ...
            <Button onClick={handleInfoDialogClose} variant="contained" sx={{ minWidth: 100 }}>
              OK
            </Button>
          )}
        </DialogActions>
      ...
      >
        <DialogTitle sx={{ pt: 4, textAlign: 'center' }}>
          ...
          >
            <Iconify
              icon={'ph:shield-warning-fill' as any}
              sx={{ color: 'warning.main', width: 40, height: 40 }}
            />
          </Box>
          <Typography variant="h6" sx={{ fontWeight: 700 }}>
            {idleSupportError?.includes('support') || idleSupportError?.includes('Incognito')
              ? 'Detection Unvailable'
              : 'Permission Required'}
          </Typography>
        </DialogTitle>
        ...
        >
          ...
          >
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, mb: 4, flexWrap: 'wrap' }}>
              <Typography
                variant="h6"
                sx={{ color: 'text.secondary', fontWeight: 500, fontFamily: 'inherit' }}
              >
