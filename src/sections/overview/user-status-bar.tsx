...
export function UserStatusBar() {
    ...
    const userData = {
        ...
        accountType: 'My Microsoft account',
    };
    ...
    return (
        <>
            ...
            >
                ...
                {statusOptions.map((item) => (
                    ...
                    >
                        <Stack direction="row" alignItems="center" spacing={1}>
                            ...
                            >
                                <Iconify icon={item.icon} width={12} />
                            </Box>
                ...
                >
                    <Stack direction="row" alignItems="center" spacing={1}>
                        <Iconify icon="eva:edit-2-outline" width={20} sx={{ color: 'text.secondary' }} />
                ...
                >
                    <Iconify icon="eva:plus-circle-outline" width={20} sx={{ mr: 1.5, color: 'text.secondary' }} />
                    <Typography variant="body2" sx={{ fontWeight: 500 }}>
                        Add another account
                    </Typography>
                </MenuItem>
