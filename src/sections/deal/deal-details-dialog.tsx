                ...
                <Stack spacing={5}>
                  ...
                  <Box>
                    ...
                    <Stack spacing={2.5} sx={{ mt: 2.5 }}>
                      <DetailItem
                        label="Contact"
                        value={deal.contact_name || deal.contact}
                        icon="solar:user-bold"
                      />
                      <DetailItem
                        label="Source Lead"
                        value={deal.source_lead}
                        icon="solar:tag-horizontal-bold"
                      />
                      <DetailItem
                        label="Deal Owner"
                        value={deal.deal_owner || deal.owner}
  ...
  return (
    <Stack direction="row" spacing={1.5}>
      <Iconify
        icon={icon as any}
        width={20}
        sx={{ mt: 0.5, color: 'text.disabled', opacity: 0.64 }}
      />
      <Box>
        <Typography
          variant="caption"
        ...
        <Typography
          variant="body2"
          sx={{ fontWeight: 700, color, wordBreak: 'break-word', lineHeight: 1.4 }}
        >
          {value || '—'}
        </Typography>
      </Box>
