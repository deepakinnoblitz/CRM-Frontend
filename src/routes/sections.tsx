...
export const EmailTemplateCategoryPage = lazy(() => import('src/pages/email-template-category'));
export const WhatsAppTemplateCategoryPage = lazy(() => import('src/pages/whatsapp-template-category'));
