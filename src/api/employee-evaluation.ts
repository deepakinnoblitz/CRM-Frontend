...
export async function fetchEmployeeEvaluationTraits(params: {
  ...
  const [res, countRes] = await Promise.all([
    ...
    frappeRequest(
      `/api/method/frappe.client.get_count?doctype=Evaluation Trait&filters=${encodeURIComponent(JSON.stringify(filters))}&or_filters=${encodeURIComponent(JSON.stringify(or_filters))}`
    ),
  ]);
...
export async function fetchEmployeeEvaluationTrait(name: string): Promise<EmployeeEvaluationTrait> {
  const res = await frappeRequest(
    `/api/method/frappe.client.get?doctype=Evaluation Trait&name=${name}`
  );
...
export async function updateEmployeeEvaluationTrait(
  name: string,
  data: Partial<EmployeeEvaluationTrait>
) {
...
export async function createEmployeeEvaluationTraitCategory(
...
export async function updateEmployeeEvaluationTraitCategory(
  name: string,
  data: Partial<EvaluationTraitCategory>
) {
  const res = await frappeRequest('/api/method/frappe.client.set_value', {
...
export async function fetchEmployeeEvaluationEvents(params: {
  ...
  const [res, countRes] = await Promise.all([
    frappeRequest(`/api/method/frappe.client.get_list?${query.toString()}`),
    frappeRequest(
      `/api/method/frappe.client.get_count?doctype=Employee Evaluation&filters=${encodeURIComponent(JSON.stringify(filters))}&or_filters=${encodeURIComponent(JSON.stringify(or_filters))}`
    ),
  ]);
...
export async function fetchEmployeeEvaluationScoreLogs(params: {
  ...
  const [res, countRes] = await Promise.all([
    frappeRequest(`/api/method/frappe.client.get_list?${query.toString()}`),
    frappeRequest(
      `/api/method/frappe.client.get_count?doctype=Employee Evaluation Score Log&filters=${encodeURIComponent(JSON.stringify(filters))}&or_filters=${encodeURIComponent(JSON.stringify(or_filters))}`
    ),
  ]);
...
export async function submitEmployeeEvaluationEvent(
  doc: Partial<EmployeeEvaluationEvent> & { doctype: string }
) {
...
export async function deleteEmployeeEvaluationEvent(name: string) {
  const res = await frappeRequest(
    '/api/method/company.company.doctype.employee_evaluation.employee_evaluation.hard_delete_evaluation',
    {
      method: 'POST',
      headers: await getAuthHeaders(),
      body: JSON.stringify({
...
export async function updateEmployeeEvaluationEvent(
  name: string,
  data: Partial<EmployeeEvaluationEvent>
) {
  const res = await frappeRequest('/api/method/frappe.client.set_value', {
    method: 'POST',
    headers: await getAuthHeaders(),
...
export async function resetEmployeeScores(password: string, employees?: string[]) {
  const res = await frappeRequest(
    '/api/method/company.company.doctype.employee_evaluation.employee_evaluation.reset_employee_scores',
    {
      method: 'POST',
      headers: await getAuthHeaders(),
      body: JSON.stringify({
