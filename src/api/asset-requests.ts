...
export async function submitAssetRequest(data: {
    ...
    const response = await frappeRequest('/api/method/company.company.frontend_api.submit_asset_request', {
        method: 'POST',
...
export async function approveDeclaration(payload: {
    ...
    const response = await frappeRequest('/api/method/company.company.frontend_api.approve_declaration', {
        method: 'POST',
