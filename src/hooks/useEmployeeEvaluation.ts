import type { EmployeeEvaluationPoint, EvaluationTraitCategory } from 'src/api/employee-evaluation';
...
export function useEmployeeEvaluationTraits(
  page: number,
  pageSize: number,
  search?: string,
  sortBy?: string,
...
export function useEmployeeEvaluationEvents(
  page: number,
  pageSize: number,
  search?: string,
  sortBy?: string,
...
export function useEmployeeEvaluationScoreLogs(
  page: number,
  pageSize: number,
  search?: string,
  sortBy?: string,
